...
public class SAMLAuthenticationProviderTest {
    ...
    @Test
    public void teste() {
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("/securityContext.xml");
        applicationContext.getBean("samlAuthenticationProvider");
    }
...
//        SAMLBinding sAMLBinding = new SAMLBindingImpl
//        SAMLProcessor sAMLProcessor = new SAMLProcessorImpl(binding)
